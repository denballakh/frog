...
- Allow optimized builds to substitute a no-op implementation for the implicit
  builtins-module `assert` procedure. Its postfix operands should retain normal
