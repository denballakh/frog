...
The compiler supports module-aware macros, an embedded standard macro prelude, scalar C foreign-function declarations, and root-relative imports of procedures, external functions, and macros, including aliases, grouped imports, and reexports.
