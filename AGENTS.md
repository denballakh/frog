...
- `union Name case Variant [PayloadType] ... end` defines a nominal by-value tagged union. `Name:variant` constructs, `Name.variant?` preserves and tests a validated value, and `Name.variant` performs a checked projection.
