...
run_error functions_alias_reserved 'invalid imported name'
run_error functions_alias_invalid_identifier 'function import alias must be an identifier'
run_error functions_alias_collision 'import alias conflict'
run_error functions_nominal_mismatch 'compile-time stack type mismatch'
run_large_path_error
